        ...
        {promotions.map((promo: any, idx: number) => {
          ...
          return (
            <button
              ...
              className="shrink-0 w-40 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-orange-200 transition-all overflow-hidden text-left cursor-pointer"
            >
